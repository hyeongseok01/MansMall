...
import com.mansmall.service.AdProductService;
...
public class AdproductController {
	...
	public String poductInsertPost(ProductVO vo,RedirectAttributes rttr) throws Exception{
		...
		public void productList(@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception{
			...
			logger.info("상품리스트(productList) 실행중");
