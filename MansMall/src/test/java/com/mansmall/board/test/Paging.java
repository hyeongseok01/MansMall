...
public class Paging {
	...
	@Test
	public void paging(SearchVO search) throws Exception {
		
		//총 게시물 수 구하는 테스트
		System.out.println("==================================");
		System.out.println("# 총 게시물 수:" +dao.BoardCount(search));
		System.out.println("==================================");
		...
		int endPage = (int)Math.ceil(vo.getPage()/(double)displayPage)*displayPage;
